...
create_kfold_datasets(
    images_dir="../../data/dataset_etiquetado_pies/b_etiquetados/images",
    labels_dir="../../data/dataset_etiquetado_pies/b_etiquetados/labels",
    output_base_dir="../../data/dataset_etiquetado_pies/c_split_cross_valid",
    dataset_name="",
    k_folds=10,
    seed=42,
)
...
copiar_archivos_generales_folds(
    origen_dir="../../data/dataset_etiquetado_pies/b_etiquetados",
    destino_base_dir="../../data/dataset_etiquetado_pies/c_split_cross_valid",
    dataset_name="",
