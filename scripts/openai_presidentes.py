...
MODEL = "gpt-5-mini"
PROMPT = 'EN BASE AL TEXTO DE LA IMAGEN, IGNORANDO CUALQUIER SELLO O TEXTO PARCIALMENTE TAPADO, DEVUELVE ÚNICAMENTE UN JSON CON LAS LLAVES: "texto" (TEXTO COMPLETO UTILIZADO PARA LA EXTRACCIÓN, EN MAYÚSCULAS) Y "presidente" (NOMBRE COMPLETO EN MAYÚSCULAS); PARA "presidente", BUSCA ESPECÍFICAMENTE UN NOMBRE EN FORMATO "APELLIDO APELLIDO, NOMBRE(S)"; SI NO SE ENCUENTRA NINGÚN NOMBRE EN ESE FORMATO PON "null"; TODO EL CONTENIDO DEBE IR EN MAYÚSCULAS; NO AGREGUES COMENTARIOS NI TEXTO ADICIONAL, SOLO EL JSON.'
