...
OUTPUT_DIR = "/home/nahumfg/GithubProjects/parliament-voting-records/data/col_rows/columnas_easyocr"
...
def process_images():
    ...
    # Filtrar por dir_names y column=columna_1
    df_filtered = df[df["dir_name"].isin(dir_names_set) & (df["column"] == "columna_1")]
    print(f"✓ Después de filtrar por dir_names y columna_1: {len(df_filtered)} registros")
