...
BASE_DATA_PATH = "/home/nahumfg/GithubProjects/parliament-voting-records/data/dataset_etiquetado_presidente/c_split_cross_valid"
PROJECT_DIR = (
    "/home/nahumfg/GithubProjects/parliament-voting-records/validation/yolo_presidente/experiments"
)
    ...
    for exp_idx, exp in enumerate(experiments, start=1):
        ...
        try:
            ...
            model.train(
                ...
                max_det=1,  # Máximo 2 detecciones por imagen
